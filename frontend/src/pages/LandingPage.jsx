    ...
    <div className="min-h-screen w-full overflow-x-hidden bg-[#F8FBFD] text-[#172B3D] flex flex-col">
      ...
      <div
        ...
        style={{
          ...
          color: "#fff",
          padding:
            "clamp(48px, 8vw, 80px) clamp(16px, 4vw, 24px) clamp(56px, 9vw, 90px)",
          textAlign: "center",
          position: "relative",
          overflow: "hidden",
        }}
      >
        ...
        >
          ...
          >
            Empowering India's Official Statistical System (MoSPI / NSSTA) with
            automated competency gap analysis, multi-source evidence extraction,
            iGOT Karmayogi integration, and dynamic LLM quiz generation.
          </Paragraph>
          ...
          >
            <div style={{ textAlign: "center", marginBottom: 24 }}>
              ...
              <Title level={4} style={{ color: "#0B2641", margin: "4px 0 0" }}>
                "FROM IDENTIFYING COMPETENCY GAPS → TO PROVING COMPETENCY
                IMPROVEMENT"
              </Title>
              <Text type="secondary" style={{ fontSize: 12 }}>
                Click any step below to navigate directly into that stage of the
                framework.
              </Text>
            </div>
              ...
              {[
                {
                  ...
                  desc: "FRAC Framework alignment (Role → Activities → Required Skills)",
                  icon: (
                    <SafetyCertificateOutlined
                      style={{ fontSize: 24, color: "#0B2641" }}
                    />
                  ),
                  route: "/profile",
                },
                {
                  title: "2. EVIDENCE EXTRACT",
                  desc: "Quizzes + Work Artifact analysis (60/40 weighted formula)",
                  icon: (
                    <FilePdfOutlined
                      style={{ fontSize: 24, color: "#0B2641" }}
                    />
                ...
                {
                  title: "3. GAP DIAGNOSTIC",
                  desc: "Calculates exact required vs current competency gap size",
                  icon: (
                    <RiseOutlined style={{ fontSize: 24, color: "#B9842C" }} />
                  ),
                  route: "/gaps",
                },
                {
                  title: "4. iGOT LEARNING",
                  desc: "ChromaDB semantic search recommends targeted iGOT modules",
                  icon: (
                    <BookOutlined style={{ fontSize: 24, color: "#0B2641" }} />
                  ),
                  route: "/learning",
                },
                {
                  title: "5. AI MCQ QUIZ",
                  desc: "LLM generates dynamic MCQs from uploaded course content",
                  icon: (
                    <ThunderboltOutlined
                      style={{ fontSize: 24, color: "#0B2641" }}
                    />
                ...
                {
                  title: "6. PASSPORT STAMP",
                  desc: "Records verified improvement delta in Officer Passport",
                  icon: (
                    <CheckCircleOutlined
                      style={{ fontSize: 24, color: "#3D7D70" }}
                    />
                  ),
                  route: "/passport",
                },
                  ...
                  <div
                    ...
                    onMouseEnter={(e) => {
                      ...
                      e.currentTarget.style.boxShadow =
                        "0 6px 16px rgba(12,68,124,0.12)";
                    }}
                    onMouseLeave={(e) => {
      ...
      <div
        id="pillars"
        style={{
          padding: "clamp(40px, 7vw, 60px) clamp(16px, 4vw, 24px) 40px",
          maxWidth: 1140,
          margin: "0 auto",
          flex: 1,
        }}
      >
        <div style={{ textAlign: "center", marginBottom: 40 }}>
          ...
          <Text type="secondary">
            Built strictly around official statistical capabilities for JSO,
            SSO, and ISS Officers.
          </Text>
        </div>
        ...
        <Row gutter={[24, 24]}>
          <Col xs={24} md={8}>
            ...
            >
              <SafetyCertificateOutlined
                style={{ fontSize: 32, color: "#0B2641", marginBottom: 16 }}
              />
              <Title level={4} style={{ color: "#0B2641", fontSize: 18 }}>
                Competency Passport
              </Title>
              <Paragraph style={{ color: "#465C70", fontSize: 13 }}>
                Maintains an immutable historical record of competency scores,
                evidence checkmarks, and growth trajectory line charts over
                time.
              </Paragraph>
              <Button
                type="link"
                style={{ padding: 0, color: "#0B2641", fontWeight: 600 }}
              >
          ...
          <Col xs={24} md={8}>
            ...
            >
              ...
              <Paragraph style={{ color: "#465C70", fontSize: 13 }}>
                LangChain + Google Gemini integration automatically converts
                uploaded statistical guidelines and course documents into
                validated MCQs.
              </Paragraph>
              <Button
                type="link"
          ...
          <Col xs={24} md={8}>
            ...
            >
              ...
              <Paragraph style={{ color: "#465C70", fontSize: 13 }}>
                Provides MoSPI and NSSTA leadership with anonymized, org-wide
                gap distributions and pre-vs-post training effectiveness
                analytics.
              </Paragraph>
              <Button
                type="link"
      ...
      >
        <div style={{ maxWidth: 1140, margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: 36 }}>
            <Tag
              color="blue"
              style={{ marginBottom: 8, fontSize: 12, padding: "2px 12px" }}
            >
            ...
            <Text type="secondary">
              Select any pre-configured official statistical profile to
              immediately test the platform with populated competencies & gap
              metrics.
            </Text>
          </div>
              ...
              <Col xs={24} sm={12} lg={6} key={prof.officer_id}>
                ...
                >
                  <div>
                    ...
                    <Title
                      level={5}
                      style={{ margin: "0 0 2px", color: "#172B3D" }}
                    >
                      {prof.name}
                    </Title>
                    <Text
      ...
      >
        ...
        >
          ...
          >
            Experience the complete end-to-end competency development cycle for
            official statistics officers in India.
          </Paragraph>
